function [position_max, power_max, axis1_range, axis2_range, axis3_range, power_3D] = scanXYZ_ThorlabsPM101(center, span, sampling, Zaber_params, PM101_params, notes)
...
%                 pause(0.05) % let the stages settle
                if PM101_params.default
                    ...
                    diary_str = diary_str + sprintf('%.10f%c\r', power, PM101.test_meter.meterPowerUnit);
                else
