function [position_max, power_max, axis1_range, axis2_range, axis3_range, power_3D] = scanXYZ_Picoscope(center, span, sampling, Zaber_params)
...
%
% Outputs:
% position_max: array of 3 values associated with position of maximum measured
% power
...
% setup LUCI10
luci10 = LUCI10(true);
luci10.setGain(false, 8, 1, 1); % false, gain, 1 = low noise, 1 = DC
...
try
    ...
    for i2 = axis2_range % scan in focus
        ...
        set(gca, 'YDir','normal');
        saveas(gcf, filename_root+'focus'+strrep(string(i2), '.', 'p')+'.png');
        close(gcf);
    ...
    position_max = [axis1_range(ind_max_3) axis2_range(ind_max_2) axis3_range(ind_max_1)];
